...
<body>
            ...
            <%
                ...
                try {
                    ...
                    String query = "SELECT r.Transit_Line_Name, " +
                                  "COUNT(r.ReservationNumber) as total_reservations, " +
    ...
    <div class="report-section">
        ...
        <table>
            ...
            <%
                try {
                    String recentQuery = "SELECT r.ReservationNumber, r.Username, r.Transit_Line_Name, " +
                                       "r.Origin_Station, r.Destination_Station, r.Travel_Date, " +
                                       "r.Total_Fare, r.Booking_Date " +
                                       "FROM reservation r " +
            ...
            %>
            <tr>
                <td><%= rs3.getInt("ReservationNumber") %></td>
                <td><%= rs3.getString("Username") %></td>
                <td><%= rs3.getString("Transit_Line_Name") %></td>
                <td><%= rs3.getString("Origin_Station") %></td>
                <td><%= rs3.getString("Destination_Station") %></td>
                <td><%= rs3.getDate("Travel_Date") %></td>
                <td>$<%= String.format("%.2f", rs3.getDouble("Total_Fare")) %></td>
                <td><%= rs3.getTimestamp("Booking_Date") %></td>
            </tr>
            <%
                    }
                    rs3.close();
