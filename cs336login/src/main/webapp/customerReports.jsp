        ...
        <table>
            ...
            <%
                try {
                    ...
                    queryBuilder.append("r.Origin_Station, r.Destination_Station, r.Travel_Date, ");
                    queryBuilder.append("r.Total_Fare, r.Booking_Date ");
                    ...
                    if (filterDate != null && !filterDate.trim().isEmpty()) {
                        queryBuilder.append("AND r.Travel_Date = ? ");
                    }
                    queryBuilder.append("ORDER BY r.Travel_Date DESC, r.Booking_Date DESC");
            ...
            <tr>
                ...
                <td><%= customerRs.getString("Origin_Station") %></td>
                <td><%= customerRs.getString("Destination_Station") %></td>
                <td><%= customerRs.getDate("Travel_Date") %></td>
                <td>$<%= String.format("%.2f", customerRs.getDouble("Total_Fare")) %></td>
                <td><%= customerRs.getTimestamp("Booking_Date") %></td>
            </tr>
            <%
                    }
